...
public class Constants {
	...
	public static String Custom_ScreenCapture_Path ="D:\\Chandrasekar_backup\\checkhtml\\Dashboard\\screenshots";
	...
	public static ArrayList<Datadriven> tcStepDatadriven=new ArrayList<Datadriven>();
	public static ArrayList<String> tcActualDataSetValue=new ArrayList<String>();
	public static ArrayList<String> exportedData=new ArrayList<String>();
	public static String exportData_Path ="";
	public static boolean isDDTest=false;
