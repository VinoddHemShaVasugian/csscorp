package ProductSpecificFunctions.DestinationTires;
...
import resources.ProductSpecificFunctions.DestinationTires.HomePageHelper;
...
public class HomePage extends HomePageHelper {
	/**
	 * Script Name : <b>HomePage</b> Generated : <b>Jul 11, 2013 1:43:20 AM</b>
	...
	private static void verifyLeftPanelTiresListContents() throws BSROException {
		...
		try {
			...
			WebElement faltTiresListinLeftPanel = KeyWordDrivenConstants.webDriver
					.findElement(By.id("destination-tire-list"));
			...
			while (iterator.hasNext()) {
				...
				if (tireNumberToTest == loopCount) {
					...
					String vehicleType = flatTireWidget.findElement(
							By.className("desheading1tags")).getText();
	...
	public static void verifyLeftPanelTiresList() throws BSROException {
		...
		try {
			...
			throw new BSROException(
					"FlatTires.HomePage.DestincationTires.verifyLeftPanelTiresList() function failed.");
		}
