package ProductSpecificFunctions.EcopiaTires;
...
import resources.ProductSpecificFunctions.EcopiaTires.HomePageHelper;
...
public class HomePage extends HomePageHelper {
	/**
	 * Script Name : <b>HomePage</b> Generated : <b>Jul 11, 2013 1:02:27 PM</b>
			...
			while (iterator.hasNext()) {
				...
				if (tireNumberToTest == loopCount) {
					...
					String vehicleType = flatTireWidget.findElement(
							By.className("ecopiah1")).getText();

					String tyreModel = flatTireWidget.findElement(
							By.className("ecopiah2")).getText();
	...
	public static void verifyLeftPanelTiresList() throws BSROException {
		...
		try {
			...
			logError("FlatTires.HomePage.EcopiaTires.verifyLeftPanelTiresList() function failed.");
