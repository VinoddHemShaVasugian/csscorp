...
import resources.ProductSpecificFunctions.Store.Verification.VerifyMyStoreLogoForSelectedStoreHelper;
 ...
 * @author css89714
 */
public class VerifyMyStoreLogoForSelectedStore extends
		VerifyMyStoreLogoForSelectedStoreHelper {
	/**
	 * Script Name : <b>VerifyMyStoreLogoForSelectedStore</b> Generated : <b>Jul
	 * 18, 2013 1:54:41 PM</b> Description : Functional Test Script Original
		...
		try {
			...
			while (iterator.hasNext()) {
				...
				if (isStoreIdentifiedByStoreNumber) {
					...
					if (true == isMyStoreGreenLogoExist) {

						logInfo("My Store green logo exist for already selected store.");
						...
						throw new BSROException(
								"My Store green logo does not exist for already selected store.");
			...
			logError("VerifyMyStoreLogoForSelectedStore.verify() function failed.");
