...
import resources.ProductSpecificFunctions.Store.Verification.VerifyTemporaryClosedLogoExistHelper;
 ...
 * @author css89714
 */
public class VerifyTemporaryClosedLogoExist extends
		VerifyTemporaryClosedLogoExistHelper {
	/**
	 * Script Name : <b>VerifyTemporaryClosedLogoExist</b> Generated : <b>Jul
	 * 18, 2013 4:22:33 PM</b> Description : Functional Test Script Original
	...
	public static void verify(String argStoreSelectionInfo)
		...
		try {
			...
			while (iterator.hasNext()) {
				...
				if (isStoreIdentifiedByStoreNumber) {
					...
					if (false == isMyStoreGreenLogoExist
							&& false == isSetAsMyStoreButtonExist
							&& false == isContinueButtonExist
							&& true == isTemporarlyClosedLogoExist) {

						logInfo("Temporarly closed logo exist for closed store.");
						...
						throw new BSROException(
								"Temporarly closed logo does not exist for closed store.");
			...
			logError("VerifyTemporaryClosedLogoExist.verify() function failed.");
