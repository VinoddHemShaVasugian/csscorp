...
import resources.ProductSpecificFunctions.Tires.Search.Verify.Sort.VerifyTireSearchResultsSortByHighestPriceHelper;
 ...
 * @author css89714
 */
public class VerifyTireSearchResultsSortByHighestPrice extends
		VerifyTireSearchResultsSortByHighestPriceHelper {
	/**
	 * Script Name : <b>VerifyTireSearchResultsSortByHighestPrice</b> Generated
	 * : <b>Jul 22, 2013 3:58:42 PM</b> Description : Functional Test Script
	...
	public static void verify() throws BSROException {
		...
		try {
			...
			ArrayList<String> tiresListFromDBByArticleNumber = ProductSpecificFunctions.Tires.Search.ByVehicle.TiresSearchDBResults
					.getStandardTiresArticleListSortByPriceDesc();
			...
			for (int loopCount = 0; loopCount < tiresListFromWebByTireName
				...
				tireNameFromDB = TiresSearchDBResults
						.getStandardTireResultantNameByArticleNumber(tireNameFromDB).trim();
			...
			logInfo("Tire Search Results sorted by highest price verified successfully.");

		} catch (Exception e) {
			// TODO: handle exception

			logError("VerifyStandardTireSearchResultsSortByHighestPrice.verify() function failed.");
