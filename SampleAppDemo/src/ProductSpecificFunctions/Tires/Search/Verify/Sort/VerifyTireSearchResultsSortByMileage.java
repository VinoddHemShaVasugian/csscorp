...
import resources.ProductSpecificFunctions.Tires.Search.Verify.Sort.VerifyTireSearchResultsSortByMileageHelper;
 ...
 * @author css89714
 */
public class VerifyTireSearchResultsSortByMileage extends
		VerifyTireSearchResultsSortByMileageHelper {
	/**
	 * Script Name : <b>VerifyTireSearchResultsSortByMileage</b> Generated :
	 * <b>Jul 22, 2013 3:59:31 PM</b> Description : Functional Test Script
	...
	public static void verify() throws BSROException {
		...
		try {
			...
			ArrayList<String> tiresListFromDBByArticleNumber = ProductSpecificFunctions.Tires.Search.ByVehicle.TiresSearchDBResults
					.getStandardTiresArticleListSortByMileage();
			...
			logInfo("Tire Search Results sorted by mileage verified successfully.");

		} catch (Exception e) {
			// TODO: handle exception

			logError("VerifyStandardTireSearchResultsSortByMileage.verify() function failed.");
