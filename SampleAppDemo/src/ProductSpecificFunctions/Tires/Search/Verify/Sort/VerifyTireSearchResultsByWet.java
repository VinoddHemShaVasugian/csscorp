...
import resources.ProductSpecificFunctions.Tires.Search.Verify.Sort.VerifyTireSearchResultsByWetHelper;
 ...
 * @author css89714
 */
public class VerifyTireSearchResultsByWet extends
		VerifyTireSearchResultsByWetHelper {
	/**
	 * Script Name : <b>VerifyTireSearchResultsByWet</b> Generated : <b>Jul 22,
	 * 2013 3:56:34 PM</b> Description : Functional Test Script Original Host :
	...
	public static void verify() throws BSROException {
		...
		try {
			...
			ArrayList<String> tiresListFromDBByArticleNumber = ProductSpecificFunctions.Tires.Search.ByVehicle.TiresSearchDBResults
					.getStandardTiresListSortByWetTraction();
			...
			logError("VerifyStandardTireSearchResultsByWet.verify() function failed.");
