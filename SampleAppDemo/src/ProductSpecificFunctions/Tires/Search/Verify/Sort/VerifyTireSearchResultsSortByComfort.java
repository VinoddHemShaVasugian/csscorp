...
import resources.ProductSpecificFunctions.Tires.Search.Verify.Sort.VerifyTireSearchResultsSortByComfortHelper;
 ...
 * @author css89714
 */
public class VerifyTireSearchResultsSortByComfort extends
		VerifyTireSearchResultsSortByComfortHelper {
	/**
	 * Script Name : <b>VerifyTireSearchResultsSortByComfort</b> Generated :
	 * <b>Jul 22, 2013 3:57:50 PM</b> Description : Functional Test Script
	...
	public static void verify() throws BSROException {
		...
		try {
			...
			ArrayList<String> tiresListFromDBByArticleNumber = ProductSpecificFunctions.Tires.Search.ByVehicle.TiresSearchDBResults
					.getStandardTiresListSortByComfort();
			...
			logError("VerifyStandardTireSearchResultsSortByComfort.verify() function failed.");
