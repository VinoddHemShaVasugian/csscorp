...
import resources.ProductSpecificFunctions.Tires.Search.Verify.Sort.VerifyTireSearchResultsByWinterHelper;
 ...
 * @author css89714
 */
public class VerifyTireSearchResultsByWinter extends
		VerifyTireSearchResultsByWinterHelper {
	/**
	 * Script Name : <b>VerifyTireSearchResultsByWinter</b> Generated : <b>Jul
	 * 22, 2013 3:56:59 PM</b> Description : Functional Test Script Original
	...
	public static void verify() throws BSROException {
		...
		try {
			...
			ArrayList<String> tiresListFromDBByArticleNumber = ProductSpecificFunctions.Tires.Search.ByVehicle.TiresSearchDBResults
					.getStandardTiresListSortByWinterTraction();
			...
			logError("VerifyStandardTireSearchResultsByWinter.verify() function failed.");
